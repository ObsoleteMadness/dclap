...
SRCDCLAP =  \
	...
	DIconLib.cc	 DFile.cc  DTableView.cc DTabSelect.cc	\
	dgg.c  Dvibrant.c DTracker.cc  DChildApp.cc  DClipboard.cc	\
	DFindDlog.cc  Dversion.c
...
OBJDCLAP = \
	...
	DIconLib.o  DFile.o	DTableView.o DTabSelect.o  dgg.o	\
	Dvibrant.o  DTracker.o  DChildApp.o  DClipboard.o  DFindDlog.o \
	Dversion.o
...
# network
SRCDNET = \
	DBOPclient.cc  DNetObject.cc DURL.cc \
...
OBJDNET = \
	DBOPclient.o  DNetObject.o DURL.o \
...
# dclap bio lib
SRCDBIO = \
	DREnzyme.cc    DSeqDoc.cc	DSeqList.cc	DSequence.cc DMegaSequence.cc \
	DSeqAsmDoc.cc  DSeqAsmView.cc  DAsmSequence.cc  DREPrint.cc \
...
OBJDBIO = \
	DREnzyme.o	   DSeqDoc.o    DSeqList.o	 DSequence.o DMegaSequence.o \
	DSeqAsmDoc.o  DSeqAsmView.o  DAsmSequence.o  DREPrint.o  \
