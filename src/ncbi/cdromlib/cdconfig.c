...
Boolean SelectDataSource (CharPtr section, CharPtr field1, CharPtr field2)
{
    DataSourceDbPtr dsdp;
    DataSourcePtr dsp;
...
Boolean SelectDataSourceByType (DocType type, CharPtr field1, CharPtr field2)
{
    CharPtr section;
...
Boolean SelectDataLinksByTypes (DocType type, DocType link_to_type)
{
    CharPtr field1;
    CharPtr field2;
...
extern Boolean SelectNextDataSource (void)
{
...
extern MediaPtr GetCurMedia (void)
{
    return CurMedia;
}
...
extern MediaPtr SetCurMedia (MediaPtr NewMedia)
{
    CurMedia = NewMedia;
    return CurMedia;
}
...
extern MediaPtr PreInitMedia (CharPtr mediaName)
{
    char buf[80];
    MediaPtr m;
...
extern Boolean CdIsInserted(MediaPtr media)
{
    CdMediaInfoPtr cdm;
    AsnIoPtr aip;
    EntrezInfoPtr vi;
...
extern  EntrezInfoPtr EntrezInfoMerge(void)
{
    EntrezInfoPtr new;
    Int2 MaxTypes = 0;
    MediaPtr mp;
...
extern Int2 ParseMedia(ConfCtlProc initfunc, Int2 media_mask)
{
    char media[256];
    CharPtr m1,m2;
    CharPtr word;
