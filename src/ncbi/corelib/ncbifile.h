...
size_t LIBCALL Nlm_FileRead PROTO((void *ptr, size_t size, size_t n, FILE *stream));
size_t LIBCALL Nlm_FileWrite PROTO((const void *ptr, size_t size, size_t n, FILE *stream));
int LIBCALL Nlm_FilePuts PROTO((const char *ptr, FILE * fp));
char * LIBCALL Nlm_FileGets PROTO((char *ptr, size_t size, FILE * fp));
