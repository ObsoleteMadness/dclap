...
static char * asnfilename = "asnpub.h00";
static AsnType atx[43] = {
  {401, "Pub" ,1,0,0,0,0,1,0,0,NULL,&atx[27],&atx[1],0,&atx[28]} ,
  ...
  {413, "Cit-sub" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,NULL} ,
  ...
  {0, "equiv" ,128,11,0,0,0,0,0,0,NULL,&atx[24],NULL,0,NULL} ,
  {403, "Pub-equiv" ,1,0,0,0,0,1,0,0,NULL,&atx[26],&atx[25],0,&atx[6]} ,
  {0, NULL,1,0,0,0,0,0,0,0,NULL,&atx[0],NULL,0,NULL} ,
  {314, "SET OF" ,0,17,0,0,0,0,0,0,NULL,NULL,NULL,0,NULL} ,
  {315, "CHOICE" ,0,-1,0,0,0,0,0,0,NULL,NULL,NULL,0,NULL} ,
  {402, "Pub-set" ,1,0,0,0,0,1,0,0,NULL,&atx[27],&atx[29],0,&atx[24]} ,
  {0, "pub" ,128,0,0,0,0,0,0,0,NULL,&atx[26],&atx[30],0,&atx[31]} ,
  {0, NULL,1,0,0,0,0,0,0,0,NULL,&atx[0],NULL,0,NULL} ,
  {0, "medline" ,128,1,0,0,0,0,0,0,NULL,&atx[26],&atx[32],0,&atx[33]} ,
  {0, NULL,1,0,0,0,0,0,0,0,NULL,&atx[6],NULL,0,NULL} ,
  {0, "article" ,128,2,0,0,0,0,0,0,NULL,&atx[26],&atx[34],0,&atx[35]} ,
  {0, NULL,1,0,0,0,0,0,0,0,NULL,&atx[10],NULL,0,NULL} ,
  {0, "journal" ,128,3,0,0,0,0,0,0,NULL,&atx[26],&atx[36],0,&atx[37]} ,
  {0, NULL,1,0,0,0,0,0,0,0,NULL,&atx[12],NULL,0,NULL} ,
  {0, "book" ,128,4,0,0,0,0,0,0,NULL,&atx[26],&atx[38],0,&atx[39]} ,
  {0, NULL,1,0,0,0,0,0,0,0,NULL,&atx[14],NULL,0,NULL} ,
  {0, "proc" ,128,5,0,0,0,0,0,0,NULL,&atx[26],&atx[40],0,&atx[41]} ,
  {0, NULL,1,0,0,0,0,0,0,0,NULL,&atx[16],NULL,0,NULL} ,
  {0, "patent" ,128,6,0,0,0,0,0,0,NULL,&atx[26],&atx[42],0,NULL} ,
  {0, NULL,1,0,0,0,0,0,0,0,NULL,&atx[18],NULL,0,NULL} };

static AsnModule ampx[1] = {
  { "NCBI-Pub" , "asnpub.h00",&atx[0],NULL,NULL,0,0} };
...
#define PUB_SET &at[28]
#define PUB_SET_pub &at[29]
#define PUB_SET_pub_E &at[30]
#define PUB_SET_medline &at[31]
#define PUB_SET_medline_E &at[32]
#define PUB_SET_article &at[33]
#define PUB_SET_article_E &at[34]
#define PUB_SET_journal &at[35]
#define PUB_SET_journal_E &at[36]
#define PUB_SET_book &at[37]
#define PUB_SET_book_E &at[38]
#define PUB_SET_proc &at[39]
#define PUB_SET_proc_E &at[40]
#define PUB_SET_patent &at[41]
#define PUB_SET_patent_E &at[42]
