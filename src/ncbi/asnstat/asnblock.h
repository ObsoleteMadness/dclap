...
static char * asnfilename = "asnblock.h00";
static AsnValxNode avnx[40] = {
    ...
    {20,"hiv" ,16,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[18] } ,
    {20,"standard" ,1,0.0,&avnx[19] } ,
    {20,"unannotated" ,2,0.0,&avnx[20] } ,
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,1,0.0,NULL } ,
    {20,"fun" ,0,0.0,&avnx[23] } ,
    {20,"inv" ,1,0.0,&avnx[24] } ,
    {20,"mam" ,2,0.0,&avnx[25] } ,
    {20,"org" ,3,0.0,&avnx[26] } ,
    {20,"phg" ,4,0.0,&avnx[27] } ,
    {20,"pln" ,5,0.0,&avnx[28] } ,
    {20,"pri" ,6,0.0,&avnx[29] } ,
    {20,"pro" ,7,0.0,&avnx[30] } ,
    {20,"rod" ,8,0.0,&avnx[31] } ,
    {20,"syn" ,9,0.0,&avnx[32] } ,
    {20,"una" ,10,0.0,&avnx[33] } ,
    {20,"vrl" ,11,0.0,&avnx[34] } ,
    {20,"vrt" ,12,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[36] } ,
    {20,"standard" ,1,0.0,&avnx[37] } ,
    {20,"prelim" ,2,0.0,&avnx[38] } ,
    {20,"other" ,255,0.0,NULL } ,
    {2,NULL,0,0.0,NULL } };
...
static AsnType atx[99] = {
  ...
  {0, "class" ,128,0,0,0,1,0,0,0,&avnx[21],&atx[2],&avnx[17],0,&atx[15]} ,
  {0, "div" ,128,1,0,1,0,0,0,0,NULL,&atx[2],&avnx[22],0,&atx[16]} ,
...
static AsnModule ampx[6] = {
  { "EMBL-General" , "asnblock.h00",&atx[0],NULL,&ampx[1],0,0} ,
