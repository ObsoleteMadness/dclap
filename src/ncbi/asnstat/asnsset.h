...
static char * asnfilename = "asnsset.h01";
...
static AsnType atx[28] = {
  ...
  {0, "class" ,128,3,0,0,1,0,0,0,&avnx[14],&atx[8],&avnx[0],0,&atx[9]} ,
  ...
  {0, NULL,1,0,0,0,0,0,0,0,NULL,&atx[25],NULL,0,NULL} ,
  {404, "Seq-annot" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[14]} ,
  {314, "SET OF" ,0,17,0,0,0,0,0,0,NULL,NULL,NULL,0,NULL} ,
  {311, "SEQUENCE" ,0,16,0,0,0,0,0,0,NULL,NULL,NULL,0,NULL} };

static AsnModule ampx[1] = {
  { "NCBI-Seqset" , "asnsset.h01",&atx[0],NULL,NULL,0,0} };
