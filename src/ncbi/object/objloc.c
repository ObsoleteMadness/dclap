...
*
*****************************************************************************/
SeqIdPtr LIBCALL SeqIdFree (SeqIdPtr anp)
{
    Pointer pnt;
...
*
*****************************************************************************/
Boolean LIBCALL SeqIdAsnWrite (SeqIdPtr anp, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
...
*
*****************************************************************************/
SeqIdPtr LIBCALL SeqIdAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    SeqIdPtr anp=NULL;
...
*
*****************************************************************************/
SeqIdPtr LIBCALL SeqIdDup (SeqIdPtr oldid)
{
    TextSeqIdPtr at, bt;
	GiimPtr ga, gb;
...
*
*****************************************************************************/
SeqIdPtr LIBCALL SeqIdSetFree (SeqIdPtr sip)
{
    SeqIdPtr next;
...
*
*****************************************************************************/
SeqIdPtr LIBCALL SeqIdSetAsnRead (AsnIoPtr aip, AsnTypePtr settype, AsnTypePtr elementtype)
{
    DataVal av;
    AsnTypePtr atp, atp2;
...
*
*****************************************************************************/
Boolean LIBCALL SeqIdSetAsnWrite (SeqIdPtr anp, AsnIoPtr aip, AsnTypePtr settype, AsnTypePtr elementtype)
{
    AsnTypePtr atp2;
	SeqIdPtr oldanp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
TextSeqIdPtr LIBCALL TextSeqIdNew (void)
{
	TextSeqIdPtr tsip;
...
*
*****************************************************************************/
TextSeqIdPtr LIBCALL TextSeqIdFree (TextSeqIdPtr tsip)
{
    if (tsip == NULL)
        return tsip;
...
*
*****************************************************************************/
Boolean LIBCALL TextSeqIdAsnWrite (TextSeqIdPtr tsip, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
TextSeqIdPtr LIBCALL TextSeqIdAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
...
*
*****************************************************************************/
PatentSeqIdPtr LIBCALL PatentSeqIdNew (void)
{
...
*
*****************************************************************************/
PatentSeqIdPtr LIBCALL PatentSeqIdFree (PatentSeqIdPtr psip)
{
    if (psip == NULL)
        return psip;
...
*
*****************************************************************************/
Boolean LIBCALL PatentSeqIdAsnWrite (PatentSeqIdPtr psip, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
PatentSeqIdPtr LIBCALL PatentSeqIdAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
...
*
*****************************************************************************/
GiimPtr LIBCALL GiimFree (GiimPtr gip)
{
    if (gip == NULL)
        return gip;
...
*
*****************************************************************************/
Boolean LIBCALL GiimAsnWrite (GiimPtr gip, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
GiimPtr LIBCALL GiimAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldtype;
    GiimPtr gip=NULL;
...
*
*****************************************************************************/
PDBSeqIdPtr LIBCALL PDBSeqIdNew (void)
{
	PDBSeqIdPtr pdbsip;
...
*
*****************************************************************************/
PDBSeqIdPtr LIBCALL PDBSeqIdFree (PDBSeqIdPtr pdbsip)
{
    if (pdbsip == NULL)
        return pdbsip;
...
*
*****************************************************************************/
Boolean LIBCALL PDBSeqIdAsnWrite (PDBSeqIdPtr pdbsip, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
PDBSeqIdPtr LIBCALL PDBSeqIdAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldtype;
...
*
*****************************************************************************/
SeqLocPtr LIBCALL SeqLocFree (SeqLocPtr anp)
{
    Pointer pnt;
...
*
*****************************************************************************/
Boolean LIBCALL SeqLocAsnWrite (SeqLocPtr anp, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, writetype = NULL;
    Pointer pnt;
...
*
*****************************************************************************/
SeqLocPtr LIBCALL SeqLocAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    SeqLocPtr anp=NULL;
...
*
*****************************************************************************/
Boolean LIBCALL SeqLocMixAsnWrite (SeqLocPtr anp, AsnIoPtr aip, AsnTypePtr orig)
{
	AsnTypePtr atp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
SeqLocPtr LIBCALL SeqLocMixAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	AsnTypePtr atp;
    SeqLocPtr anp=NULL;
...
*
*****************************************************************************/
Boolean LIBCALL SeqLocEquivAsnWrite (SeqLocPtr anp, AsnIoPtr aip, AsnTypePtr orig)
{
	AsnTypePtr atp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
SeqLocPtr LIBCALL SeqLocEquivAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	AsnTypePtr atp;
    SeqLocPtr anp=NULL;
...
*
*****************************************************************************/
Boolean LIBCALL SeqLocSetAsnWrite (SeqLocPtr anp, AsnIoPtr aip, AsnTypePtr set, AsnTypePtr element)
{
    AsnTypePtr atp2;
	SeqLocPtr oldanp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
SeqLocPtr LIBCALL SeqLocSetAsnRead (AsnIoPtr aip, AsnTypePtr set, AsnTypePtr element)
{
	DataVal av;
	AsnTypePtr atp, atp2;
...
*
*****************************************************************************/
SeqLocPtr LIBCALL SeqLocSetFree (SeqLocPtr anp)
{
    SeqLocPtr next;
...
*
*****************************************************************************/
SeqIntPtr LIBCALL SeqIntNew (void)
{
...
*
*****************************************************************************/
SeqIntPtr LIBCALL SeqIntFree (SeqIntPtr sip)
{
    if (sip == NULL)
        return sip;
...
*
*****************************************************************************/
Boolean LIBCALL SeqIntAsnWrite (SeqIntPtr sip, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
SeqIntPtr LIBCALL SeqIntAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldtype;
    SeqIntPtr sip=NULL;
...
*
*****************************************************************************/
Boolean LIBCALL PackSeqIntAsnWrite (SeqLocPtr sip, AsnIoPtr aip, AsnTypePtr orig)
{
	AsnTypePtr atp;
	SeqLocPtr oldsip;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
SeqLocPtr LIBCALL PackSeqIntAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldtype;
...
*
*****************************************************************************/
SeqPntPtr LIBCALL SeqPntNew (void)
{
...
*
*****************************************************************************/
SeqPntPtr LIBCALL SeqPntFree (SeqPntPtr spp)
{
    if (spp == NULL)
        return spp;
...
*
*****************************************************************************/
Boolean LIBCALL SeqPntAsnWrite (SeqPntPtr spp, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
SeqPntPtr LIBCALL SeqPntAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldtype;
    SeqPntPtr spp=NULL;
...
*
*****************************************************************************/
PackSeqPntPtr LIBCALL PackSeqPntNew (void)
{
...
*
*****************************************************************************/
PackSeqPntPtr LIBCALL PackSeqPntFree (PackSeqPntPtr pspp)
{
    PackSeqPntPtr next;
...
*
*****************************************************************************/
Boolean LIBCALL PackSeqPntAsnWrite (PackSeqPntPtr pspp, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    Int4 num, index;
...
*
*****************************************************************************/
PackSeqPntPtr LIBCALL PackSeqPntAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldtype;
...
*
*****************************************************************************/
Int4 LIBCALL PackSeqPntNum (PackSeqPntPtr pspp)
{
    Int4 num = 0;
    while (pspp != NULL)
    {
...
*
*****************************************************************************/
Int4 LIBCALL PackSeqPntGet (PackSeqPntPtr pspp, Int4 index)
{
    Int4 num = 0;
    if (index < 0)
        return -1;
...
*
*****************************************************************************/
Boolean LIBCALL PackSeqPntPut (PackSeqPntPtr pspp, Int4 point)
{
...
*
*****************************************************************************/
SeqBondPtr LIBCALL SeqBondNew (void)
{
...
*
*****************************************************************************/
SeqBondPtr LIBCALL SeqBondFree (SeqBondPtr sbp)
{
    if (sbp == NULL)
        return sbp;
...
*
*****************************************************************************/
Boolean LIBCALL SeqBondAsnWrite (SeqBondPtr sbp, AsnIoPtr aip, AsnTypePtr orig)
{
	AsnTypePtr atp;
    Boolean retval = FALSE;
...
*
*****************************************************************************/
SeqBondPtr LIBCALL SeqBondAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldtype;
    SeqBondPtr sbp=NULL;
