...
*
*****************************************************************************/
Boolean LIBCALL AccessAsnLoad PROTO((void));
...
LinkSetPtr LIBCALL LinkSetNew PROTO((void));
LinkSetPtr LIBCALL LinkSetFree PROTO((LinkSetPtr ufp));
LinkSetPtr LIBCALL LinkSetAsnRead PROTO((AsnIoPtr aip, AsnTypePtr atp));
Boolean    LIBCALL LinkSetAsnWrite PROTO((LinkSetPtr ufp, AsnIoPtr aip, AsnTypePtr atp));
