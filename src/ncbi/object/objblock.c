...
*
*****************************************************************************/
Boolean LIBCALL SeqBlockAsnLoad ()
{
    if (loaded)
        return TRUE;
    loaded = TRUE;
...
*
*****************************************************************************/
PirBlockPtr LIBCALL PirBlockNew ()
{
...
*
*****************************************************************************/
PirBlockPtr LIBCALL PirBlockFree (PirBlockPtr pbp)
{
    if (pbp == NULL)
        return pbp;
...
*
*****************************************************************************/
Boolean LIBCALL PirBlockAsnWrite (PirBlockPtr pbp, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    ValNodePtr anp;
...
*
*****************************************************************************/
PirBlockPtr LIBCALL PirBlockAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
...
*
*****************************************************************************/
GBBlockPtr LIBCALL GBBlockNew (void)
{
...
*
*****************************************************************************/
GBBlockPtr LIBCALL GBBlockFree (GBBlockPtr gbp)
{
    if (gbp == NULL)
        return gbp;
...
*
*****************************************************************************/
Boolean LIBCALL GBBlockAsnWrite (GBBlockPtr gbp, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    ValNodePtr anp;
...
*
*****************************************************************************/
GBBlockPtr LIBCALL GBBlockAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldatp;
    GBBlockPtr gbp=NULL;
...
*
*****************************************************************************/
SPBlockPtr LIBCALL SPBlockNew (void)
{
...
*
*****************************************************************************/
SPBlockPtr LIBCALL SPBlockFree (SPBlockPtr sbp)
{
    ValNodePtr anp, next;
...
*
*****************************************************************************/
Boolean LIBCALL SPBlockAsnWrite (SPBlockPtr sbp, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    ValNodePtr anp;
...
*
*****************************************************************************/
SPBlockPtr LIBCALL SPBlockAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldatp;
    SPBlockPtr sbp=NULL;
...
*
*****************************************************************************/
EMBLBlockPtr LIBCALL EMBLBlockNew (void)
{
	EMBLBlockPtr ebp;
...
*
*****************************************************************************/
EMBLBlockPtr LIBCALL EMBLBlockFree (EMBLBlockPtr ebp)
{
    ValNodePtr anp, next;
...
*
*****************************************************************************/
Boolean LIBCALL EMBLBlockAsnWrite (EMBLBlockPtr ebp, AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp;
    ValNodePtr anp;
...
*
*****************************************************************************/
EMBLBlockPtr LIBCALL EMBLBlockAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	DataVal av;
	AsnTypePtr atp, oldatp;
...
*
*****************************************************************************/
PrfBlockPtr	LIBCALL PrfBlockNew()
{
...
*
*****************************************************************************/
PrfBlockPtr	LIBCALL PrfBlockFree (PrfBlockPtr pbp)
{
	if ( pbp == NULL )
		return pbp;
...
*
*****************************************************************************/
Boolean	LIBCALL PrfBlockAsnWrite (PrfBlockPtr pbp, AsnIoPtr aip, AsnTypePtr	orig)
{
	PrfExtSrcPtr	pxsp;
	AsnTypePtr	atp;
	ValNodePtr	vnp;
...
*
*****************************************************************************/
PrfBlockPtr	LIBCALL PrfBlockAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	AsnTypePtr	atp, oldatp;
...
*
*****************************************************************************/
PdbBlockPtr	LIBCALL PdbBlockNew()
{
...
*
*****************************************************************************/
PdbBlockPtr	LIBCALL PdbBlockFree (PdbBlockPtr pdbp)
{
	if ( pdbp == NULL )
		return pdbp;
...
*
*****************************************************************************/
Boolean	LIBCALL PdbBlockAsnWrite (PdbBlockPtr pdbp,	AsnIoPtr aip, AsnTypePtr orig)
{
	PdbRepPtr	prp;
	AsnTypePtr	atp;
	ValNodePtr	vnp;
...
*
*****************************************************************************/
PdbBlockPtr	LIBCALL PdbBlockAsnRead (AsnIoPtr aip, AsnTypePtr orig)
{
	AsnTypePtr	atp, oldatp;
