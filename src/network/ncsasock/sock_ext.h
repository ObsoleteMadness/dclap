...
/* int s_fcntl(Int4 s, Int4 cmd, Int4 arg); */
int s_fcntl(Int4 s, unsigned long cmd, Int4 arg);
int s_dup(Int4 s);
...
struct hostent	*gethostbyaddr(long *addrP,Int4 len,Int4 type);
#ifndef DONT_DEFINE_INET
char *inet_ntoa(ip_addr inaddr);
/* ip_addr inet_addr(char *address); */
extern unsigned long inet_addr(const char *address);
#endif /* DONT_DEFINE_INET */
